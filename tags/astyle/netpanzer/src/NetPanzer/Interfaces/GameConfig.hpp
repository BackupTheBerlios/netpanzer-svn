...
public:
    ...
    {
        if (unit_selection_box_draw_mode == _unit_selection_box_draw_mode_rect) {
            return( "Rectangle" );
        } else if (unit_selection_box_draw_mode == _unit_selection_box_draw_mode_rect_edges) {
    ...
    {
        if (mini_map_objective_draw_mode == _mini_map_objective_draw_mode_solid_rect) {
            return( "Solid Rectangle" );
        } else if (mini_map_objective_draw_mode == _mini_map_objective_draw_mode_outline_rect) {
