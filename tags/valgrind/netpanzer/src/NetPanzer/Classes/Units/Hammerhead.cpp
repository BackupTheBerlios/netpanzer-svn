...
Hammerhead::Hammerhead( PointXYi initial_loc, unsigned char color, unsigned char flag )
   : Vehicle( initial_loc )
 {
  setUnitProperties();
...
{
  reload_counter = 0;
  ProjectileInterface::newProjectile( 1, unit_state.unit_type, unit_id, unit_state.damage_factor, 
                                      unit_state.location, 
                                      target_loc
                                     );
