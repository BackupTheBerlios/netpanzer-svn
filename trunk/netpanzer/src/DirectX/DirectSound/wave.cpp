...
//	this used to be in the open routine, but was
//	taken out and moved to a separate routine so there was
//	more control on the chunks that are before
...
//	Makre sure we're descended into
...
//	Be careful, wave files can get pretty big these days :).  
//		szFileName      -	szFilename
//		cbSize          -	Size of loaded wave (returned)
//		cSamples        -	# of samples loaded.
//		ppwfxInfo       -	Pointer to pointer to waveformatex structure.
//							The wfx structure IS ALLOCATED by this routine!
//							Make sure to free it!
//		ppbData         -   Pointer to a byte pointer (globalalloc) which is
