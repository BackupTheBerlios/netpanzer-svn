...
static void bSetPlayerRadarUnitWhite()
{
    GameConfig::setPlayerRadarUnitColor(Color::white);
}
static void bSetPlayerRadarUnitBlack()
{
    GameConfig::setPlayerRadarUnitColor(Color::black);
}
static void bSetPlayerRadarUnitGray()
{
    GameConfig::setPlayerRadarUnitColor(Color::gray128);
}
static void bSetPlayerRadarUnitRed()
{
    GameConfig::setPlayerRadarUnitColor(Color::red);
}
static void bSetPlayerRadarUnitLightRed()
{
    GameConfig::setPlayerRadarUnitColor(Color::lightRed);
}
static void bSetPlayerRadarUnitGreen()
{
    GameConfig::setPlayerRadarUnitColor(Color::green);
}
static void bSetPlayerRadarUnitLightGreen()
{
    GameConfig::setPlayerRadarUnitColor(Color::lightGreen);
}
static void bSetPlayerRadarUnitBlue()
{
    GameConfig::setPlayerRadarUnitColor(Color::blue);
}
static void bSetPlayerRadarUnitLightBlue()
{
    GameConfig::setPlayerRadarUnitColor(Color::lightBlue);
}
static void bSetPlayerRadarUnitOrange()
{
    GameConfig::setPlayerRadarUnitColor(Color::orange);
}
static void bSetPlayerRadarUnitYellow()
{
    GameConfig::setPlayerRadarUnitColor(Color::yellow);
}

static void bSetAlliedRadarUnitWhite()
{
    GameConfig::setAlliedRadarUnitColor(Color::white);
}
static void bSetAlliedRadarUnitBlack()
{
    GameConfig::setAlliedRadarUnitColor(Color::black);
}
static void bSetAlliedRadarUnitGray()
{
    GameConfig::setAlliedRadarUnitColor(Color::gray128);
}
static void bSetAlliedRadarUnitRed()
{
    GameConfig::setAlliedRadarUnitColor(Color::red);
}
static void bSetAlliedRadarUnitLightRed()
{
    GameConfig::setAlliedRadarUnitColor(Color::lightRed);
}
static void bSetAlliedRadarUnitGreen()
{
    GameConfig::setAlliedRadarUnitColor(Color::green);
}
static void bSetAlliedRadarUnitLightGreen()
{
    GameConfig::setAlliedRadarUnitColor(Color::lightGreen);
}
static void bSetAlliedRadarUnitBlue()
{
    GameConfig::setAlliedRadarUnitColor(Color::blue);
}
static void bSetAlliedRadarUnitLightBlue()
{
    GameConfig::setAlliedRadarUnitColor(Color::lightBlue);
}
static void bSetAlliedRadarUnitOrange()
{
    GameConfig::setAlliedRadarUnitColor(Color::orange);
}
static void bSetAlliedRadarUnitYellow()
{
    GameConfig::setAlliedRadarUnitColor(Color::yellow);
}

static void bSetPlayerOutpostRadarWhite()
{
    GameConfig::setPlayerOutpostRadarColor(Color::white);
}
static void bSetPlayerOutpostRadarBlack()
{
    GameConfig::setPlayerOutpostRadarColor(Color::black);
}
static void bSetPlayerOutpostRadarGray()
{
    GameConfig::setPlayerOutpostRadarColor(Color::gray128);
}
static void bSetPlayerOutpostRadarRed()
{
    GameConfig::setPlayerOutpostRadarColor(Color::red);
}
static void bSetPlayerOutpostRadarLightRed()
{
    GameConfig::setPlayerOutpostRadarColor(Color::lightRed);
}
static void bSetPlayerOutpostRadarGreen()
{
    GameConfig::setPlayerOutpostRadarColor(Color::green);
}
static void bSetPlayerOutpostRadarLightGreen()
{
    GameConfig::setPlayerOutpostRadarColor(Color::lightGreen);
}
static void bSetPlayerOutpostRadarBlue()
{
    GameConfig::setPlayerOutpostRadarColor(Color::blue);
}
static void bSetPlayerOutpostRadarLightBlue()
{
    GameConfig::setPlayerOutpostRadarColor(Color::lightBlue);
}
static void bSetPlayerOutpostRadarOrange()
{
    GameConfig::setPlayerOutpostRadarColor(Color::orange);
}
static void bSetPlayerOutpostRadarYellow()
{
    GameConfig::setPlayerOutpostRadarColor(Color::yellow);
}

static void bSetAlliedOutpostRadarWhite()
{
    GameConfig::setAlliedOutpostRadarColor(Color::white);
}
static void bSetAlliedOutpostRadarBlack()
{
    GameConfig::setAlliedOutpostRadarColor(Color::black);
}
static void bSetAlliedOutpostRadarGray()
{
    GameConfig::setAlliedOutpostRadarColor(Color::gray128);
}
static void bSetAlliedOutpostRadarRed()
{
    GameConfig::setAlliedOutpostRadarColor(Color::red);
}
static void bSetAlliedOutpostRadarLightRed()
{
    GameConfig::setAlliedOutpostRadarColor(Color::lightRed);
}
static void bSetAlliedOutpostRadarGreen()
{
    GameConfig::setAlliedOutpostRadarColor(Color::green);
}
static void bSetAlliedOutpostRadarLightGreen()
{
    GameConfig::setAlliedOutpostRadarColor(Color::lightGreen);
}
static void bSetAlliedOutpostRadarBlue()
{
    GameConfig::setAlliedOutpostRadarColor(Color::blue);
}
static void bSetAlliedOutpostRadarLightBlue()
{
    GameConfig::setAlliedOutpostRadarColor(Color::lightBlue);
}
static void bSetAlliedOutpostRadarOrange()
{
    GameConfig::setAlliedOutpostRadarColor(Color::orange);
}
static void bSetAlliedOutpostRadarYellow()
{
    GameConfig::setAlliedOutpostRadarColor(Color::yellow);
}

static void bSetEnemyOutpostRadarWhite()
{
    GameConfig::setEnemyOutpostRadarColor(Color::white);
}
static void bSetEnemyOutpostRadarBlack()
{
    GameConfig::setEnemyOutpostRadarColor(Color::black);
}
static void bSetEnemyOutpostRadarGray()
{
    GameConfig::setEnemyOutpostRadarColor(Color::gray128);
}
static void bSetEnemyOutpostRadarRed()
{
    GameConfig::setEnemyOutpostRadarColor(Color::red);
}
static void bSetEnemyOutpostRadarLightRed()
{
    GameConfig::setEnemyOutpostRadarColor(Color::lightRed);
}
static void bSetEnemyOutpostRadarGreen()
{
    GameConfig::setEnemyOutpostRadarColor(Color::green);
}
static void bSetEnemyOutpostRadarLightGreen()
{
    GameConfig::setEnemyOutpostRadarColor(Color::lightGreen);
}
static void bSetEnemyOutpostRadarBlue()
{
    GameConfig::setEnemyOutpostRadarColor(Color::blue);
}
static void bSetEnemyOutpostRadarLightBlue()
{
    GameConfig::setEnemyOutpostRadarColor(Color::lightBlue);
}
static void bSetEnemyOutpostRadarOrange()
{
    GameConfig::setEnemyOutpostRadarColor(Color::orange);
}
static void bSetEnemyOutpostRadarYellow()
{
    GameConfig::setEnemyOutpostRadarColor(Color::yellow);
}
