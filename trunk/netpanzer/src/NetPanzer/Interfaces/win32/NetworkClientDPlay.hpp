...
*/
#ifndef _NETWORK_CLIENT_DPLAY_HPP
#define _NETWORK_CLIENT_DPLAY_HPP
...
class NetworkClientDPlay : public NetworkClient
 {
  protected:
   DPID server_DPID;
...
#endif // ** _NETWORK_CLIENT_DPLAY_HPP
