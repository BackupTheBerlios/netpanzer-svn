...
class MapInterface : protected TileInterface
 {
  ...
  public: 
   ...
   static inline MapElementType MapValue( unsigned short map_x, unsigned short map_y )
    {
   ...
   static void mapXYtoPointXY( unsigned short map_x, unsigned short map_y, unsigned long *point_x, unsigned long *point_y )
     {
   ...
   static inline void pointXYtoMapXY( unsigned long point_x, unsigned long point_y, unsigned short *map_x, unsigned short *map_y )
     {
  ...
  static inline void pointXYtoMapXY( PointXYi point, PointXYi *map_loc )
   ...
   static inline void mapXYtoOffset( unsigned short map_x, unsigned short map_y, unsigned long *offset )
    {
