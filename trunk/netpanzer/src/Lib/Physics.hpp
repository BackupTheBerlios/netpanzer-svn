...
public:
	...
	public:
		...
		void setSpeed(float speed) { this->speed = speed; setVelocity(speed, direction); }
		void setDirection(int direction) { this->direction = direction; setVelocity(speed, direction); }
		void setDirectionN()  { direction = 157; setVelocity(speed, direction); }
		void setDirectionNE() {}
		void setDirectionE()  { direction = 0; setVelocity(speed, direction); }
		void setDirectionSE() {}
		void setDirectionS()  { direction = 471; setVelocity(speed, direction); }
		void setDirectionSW() {}
		void setDirectionW()  { direction = 314; setVelocity(speed, direction); }
		void setDirectionNW() {}

		fXYZ getDisplacement() const { return displacement; }
	};
...
public:
	...
	static void setGravity(float gravity) { Physics::gravity = gravity; }
