...
SDL_Color NamedColors::colors[] =
{
	...
	{ 64,  64,  64,   0}, // gray64
	{ 96,  96,  96,   0}, // gray96
	{128, 128, 128,   0}, // gray128
	{160, 160, 160,   0}, // gray160
	{192, 192, 192,   0}, // gray192
	{224, 224, 224,   0}, // gray224
	{255, 255, 255,   0}, // white
	{  0,   0, 255,   0}, // blue
	{128,  42,  42,   0}, // brown
//	{200,  80,  80,   0}, // brown clear
	{  0, 255, 255,   0}, // cyan
	{128, 128, 128,   0}, // gray (is gray128)
	{  0, 255,   0,   0}, // green
	{255,   0, 255,   0}, // magenta
	{255, 128,   0,   0}, // orange
	{255, 192, 203,   0}, // pink
	...
	{255, 255,   0,   0}, // yellow
	{  0,   0, 128,   0}, // darkBlue
	{128,  42,  42,   0}, // darkBrown (same as normal brown)
	{  0, 206, 209,   0}, // darkCyan
	{ 64,  64,  64,   0}, // darkGray (is gray64)
	{  0, 128,   0,   0}, // darkGreen
	{148,   0, 211,   0}, // darkMagenta
	{255, 140,   0,   0}, // darkOrange
	{255, 192, 203,   0}, // darkPink (same as normal pink)
	{128,   0,   0,   0}, // darkRed
	{255, 168,  18,   0}, // darkYellow
	{135, 206, 250,   0}, // lightBlue
	{200,  80,  80,   0}, // lightBrown
	{224, 255, 255,   0}, // lightCyan
	{192, 192, 192,   0}, // lightGray (is gray192)
	{ 50, 205,  50,   0}, // lightGreen
	{  0, 255, 255,   0}, // lightMagenta
	{237, 145,  33,   0}, // lightOrange
	{255, 192, 203,   0}, // lightPink (same as normal pink)
	{255, 160, 122,   0}, // lightRed
	{255, 255, 224,   0}, // lightYellow
	{210, 180, 140,   0}, // tan
	{127, 255,   0,   0}, // chartreuse
	{ 61, 145,  64,   0}, // cobaltGreen
	{  0, 201,  87,   0}, // emeraldGreen
	{ 34, 139,  34,   0}, // forestGreen
	{ 85, 107,  47,   0}, // darkOliveGreen
	{ 56,  94,  15,   0}, // terreVerte

	{  0, 204, 255,   0}, // unitAqua
	{255, 255,   0,   0}, // unitYellow
	{255,   0,   0,   0}, // unitRed
	{  3,   3, 255,   0}, // unitBlue
	{  0,   0, 128,   0}, // unitDarkBlue
	{163, 214, 159,   0}, // unitLightGreen
	{ 31, 166,  36,   0}, // unitGreen
	{ 43,  85, 131,   0}, // unitBlueGray
	{150,   0,   0,   0}, // unitDarkRed
	{  6,   2,   2,   0}, // unitBlack
	{ 26,  88,  36,   0}, // unitDarkGreen
	{250, 253, 248,   0}, // unitWhite
	{246, 210,  99,   0}, // unitLightOrange
	{205, 144,   9,   0}, // unitOrange
	{186, 186, 186,   0}, // unitGray
	{ 99, 100, 102,   0}, // unitDarkGray

};

// This is the baddest thing since sliced bread.  This is some list my brother found on the
// internet of the RGB color values of a freaking crayon box.
