//
// $Id: command_line.hpp,v 1.1 2003/09/11 17:35:46 MatzeBraun Exp $ 
//  
...
namespace optionmm
{
  ...
  public:
    ...
    void add(basic_option* option) { _options.push_back(option); }
  ...
  {
    inline void operator()(bool& x) { x = !x; }
#if defined(__GNUC__) && __GNUC__ >= 2
    inline void operator()(std::_Bit_reference x) { x.flip(); }
#endif
  };
