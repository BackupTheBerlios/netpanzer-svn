...
public:
	...
	const Surface &getDisableIcon() { return disableIcon; }
	const Surface &getIcon() { return icon; }
	const Surface &getPressedIcon() { return pressedIcon; }
	const Surface &getRolloverIcon() { return rolloverIcon; }
	const Surface &getRolloverSelectedIcon() { return rolloverSelectedIcon; }
