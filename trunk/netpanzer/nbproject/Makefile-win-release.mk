...
# Object Directory
OBJECTDIR=build/win-release/GNU-Windows
...
# Build Targets
.build-conf: ${BUILD_SUBPROJECTS} dist/win-release/GNU-Windows/netpanzer.exe

dist/win-release/GNU-Windows/netpanzer.exe: ${OBJECTFILES}
	${MKDIR} -p dist/win-release/GNU-Windows
	${LINK.cc} -o dist/win-release/GNU-Windows/netpanzer ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf:
	...
	${RM} dist/win-release/GNU-Windows/netpanzer.exe
